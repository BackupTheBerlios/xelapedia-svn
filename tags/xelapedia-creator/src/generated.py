#!/usr/bin/env python
# -*- coding: utf-8 -*-
# generated by wxGlade 0.6.3 on Sun Jul 13 18:20:50 2008
...
class AboutDialogBase(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.buttonOK = wx.Button(self, -1, _("&OK"))

        self.__set_properties()
        self.__do_layout()

        self.Bind(wx.EVT_BUTTON, self.buttonOKHandler, self.buttonOK)
        # end wxGlade
    ...
    def __do_layout(self):
        ...
        mainSizer.Add(self.buttonOK, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL, 5)
